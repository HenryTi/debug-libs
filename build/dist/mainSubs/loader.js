...
var Loader = /** @class */ (function () {
    ...
    */
    //}
    Loader.prototype.loadSchemas = function () {
                ...
                switch (_a.label) {
                    case 0:
                        if (this.schemaLoaded === true)
                            return [2 /*return*/];
                        return [4 /*yield*/, Promise.all(this.entities)];
                    case 1:
                        _a.sent();
    ...
    Loader.prototype.load = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadSchemas()];
                    case 1:
                        _a.sent();
                        data = {};
                        return [4 /*yield*/, this.loadToData(data)];
                    case 2:
                        _a.sent();
